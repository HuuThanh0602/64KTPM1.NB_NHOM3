        ...
        <ul class="pagination pagination-s1 flex-wrap justify-content-center py-2">
            @if ($paginator->onFirstPage())
                <li class="page-item disabled"> <a class="page-link" href="#"> <em
                            class="ni ni-chevron-left icon"></em> </a>
                </li>
            @else
                <li class="page-item"> <a class="page-link" href="{{ $paginator->previousPageUrl() }}"> <em
            ...
            @if ($paginator->hasMorePages())
                <li class="page-item"> <a class="page-link" href="{{ $paginator->nextPageUrl() }}"> <em
                            class="ni ni-chevron-right icon"></em> </a> </li>
            @else
                <li class="page-item disabled"> <a class="page-link" href="#"> <em
                            class="ni ni-chevron-right icon"></em> </a>
                </li>
            @endif
        </ul>
    </nav>
